...
//            }
    ...
    private static String checkSortCode(int idCardType ,int sex,String idCardInput){
        ...
        return sortCode == sex ? ACCEPT : "身份证号码与性别不符合";
    }
    ...
    public static void main(String[]args) {
        ...
        String idCard = "35223119711303262X"; //错误的
        //验证身份证是否合法
        System.out.println(chekIdCard(2, idCard));

        //验证身份证的地域编码是符合规则 
        System.out.println(checkArea(idCard));

        //验证身份证号码数字字母组成是否符合规则 
        System.out.println(checkNumber(5, idCard));

       // 验证身份证号码出生日期是否符合规则
       System.out.println(checkBirthDate(6,idCard));

       // 验证身份证号码顺序码是否符合规则,男性为奇数数,女性为偶数
       System.out.println(checkSortCode(1 , 1, idCard));
